 ...
 * Автор Yurik
 * Дата конфігурації: 17.03.2020 18:17:09
 *
 */
...
namespace ConfTrade_v1_1.РегістриВідомостей
{
    ...
    #region REGISTER "Перший_Копія_1"
    
    
    class Перший_Копія_1_RecordsSet : RegisterInformationRecordsSet
    {
        public Перший_Копія_1_RecordsSet() : base(Config.Kernel, "tab_b11",
             new string[] { "col_field0", "col_field12", "col_field13", "col_field11", "col_field1", "col_field2", "col_field3", "col_field4", "col_fiel5", "col_field6", "col_a1" }) 
        {
            Records = new List<Record>();
            Filter = new SelectFilter();
...
namespace ConfTrade_v1_1.РегістриНакопичення
{
    ...
    class Перший_Копія_1_RecordsSet : RegisterAccumulationRecordsSet
    {
        public Перший_Копія_1_RecordsSet() : base(Config.Kernel, "tab_b12",
             new string[] { "col_field1", "col_a1", "col_a3", "col_a4", "col_field2", "col_a8", "col_field3", "col_a2", "col_a5" }) 
        {
            Records = new List<Record>();
            Filter = new SelectFilter();
