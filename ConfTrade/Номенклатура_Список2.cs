...
namespace ConfTrade
{
    public partial class ConfTrade
    {
        public static string Run()
        {
            ...
            //foreach (KeyValuePair<string, string> m in m_Номенклатура_Список2_View.Alias)
            //{
            ...
            m_Единици_Список_View.QuerySelect.Where.Add(
                new Where("uid", Comparison.IN, /* col_d2 */ 
                "SELECT DISTINCT " + m_Номенклатура_Список2_View.Alias["ЕдиницаПоУмолчанию"] + 
                " FROM " + m_Номенклатура_Список2_View.QuerySelect.TempTable, true));
            ...
            m_КодиУКТВЕД_Список_View.QuerySelect.Where.Add(
                new Where("uid", Comparison.IN, /* col_e8 */ 
                "SELECT DISTINCT " + m_Номенклатура_Список2_View.Alias["КодУКТВЕД"] + 
                " FROM " + m_Номенклатура_Список2_View.QuerySelect.TempTable, true));
