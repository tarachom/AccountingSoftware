            ...
            <tr>
              <td>
                <xsl:call-template name="GetNameSelect">
                  <xsl:with-param name="pointer">Перелічення.ВидиТоварів</xsl:with-param>
                  <xsl:with-param name="value" select="ВидТовара" />
                </xsl:call-template>
              </td>
              <td>
              ...
              <td>
                <xsl:call-template name="GetNameOd">
                  <xsl:with-param name="list" select="/root/Довідники.КлассификаторЕдИзм_Список" />
              ...
              <td>
                <xsl:call-template name="GetNameOd">
                  <xsl:with-param name="list" select="/root/Довідники.Групи_Номенклатура_Список" />
