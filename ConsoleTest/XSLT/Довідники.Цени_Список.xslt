...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <body>
    <table border="1">
      <xsl:for-each select="root/Довідники.Цени_Список/row">
      <tr>
        ...
        <td><xsl:call-template name="GetNameOd"><xsl:with-param name="list" select="/root/Довідники.КатегорииЦен_Список" /><xsl:with-param name="uid" select="КатегорияЦени" /></xsl:call-template></td>
