...
namespace ConfTrade
{
    public partial class ConfTrade
    {
        public static string Run()
        {
            ...
            Довідники.Довідники.МестаХранения_Список_View m_Довідники.МестаХранения_Список_View = new Довідники.Довідники.МестаХранения_Список_View();
            m_Довідники.МестаХранения_Список_View.QuerySelect.Where.Add(new Where("uid", Comparison.IN, 
                "SELECT DISTINCT " + Alias["Родитель"] + " FROM " + m_Групи_МестаХранения_Список_View.QuerySelect.TempTable, true)); /* col_a3 */
            sb.Append(m_Довідники.МестаХранения_Список_View.Read());
