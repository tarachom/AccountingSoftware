...
namespace ConfTrade
{
    public partial class ConfTrade
    {
        public static string Run()
        {
            ...
            Довідники.Валюти_Список_View m_3 = new Довідники.Валюти_Список_View();
            m_3.QuerySelect.Where.Add(new Where("uid", Comparison.IN, "SELECT DISTINCT " + Alias["ВалютаУчета"] + " FROM " + TempTable, true));
            sb.Append(m_3.Read());
