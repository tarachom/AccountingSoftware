...
namespace ConfTrade
{
    public partial class ConfTrade
    {
        public static string Run()
        {
            ...
            Довідники.Номенклатура_Групи_Список_View m_1 = new Довідники.Номенклатура_Групи_Список_View();
            ...
            Довідники.Номенклатура_Групи_Список_View m_3 = new Довідники.Номенклатура_Групи_Список_View();
